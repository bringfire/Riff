...
def test_presenter_header_serves_dark_riff_logo():
    presenter = client.get("/riff/presenter.html?snapshot_id=demo")
    ...
    assert logo.content == (WEB_DIR / "riff-logo-dark.png").read_bytes()
